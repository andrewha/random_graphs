 ...
 * @brief Library for enumerating and calculating the probability of connectedness of random labeled undirected graphs constructed with the Erdős-Rényi and Gilbert models
 * @version 0.1
 * @date 2023-08-28
 *
